...
const apiData = {
            ...
            "get-dongman-video": {
              "title": "获取动漫视频",
              "method": "GET",
              "apiUrl": "https://m1.apifoxmock.com/m1/7510026-7245733-default/getDongManVideos",
            ...
            "/getwords": {
              "title": "获取年级单词",
              "method": "GET",
              "apiUrl": "https://m1.apifoxmock.com/m1/7510026-7245733-default/getwords",
              "paramDescription": "接口链接：https://m1.apifoxmock.com/m1/7510026-7245733-default/getwords",
              "params": [
                {
                  "name": "grade",
                  "type": "String",
                ...
                },
                {
                  "name": "token",
                  "type": "String",
                  "description": "用户登录的token信息",
                  "defaultValue": "admin_abc123xyz",
                  "example": "admin_abc123xyz，usdf_2df2ffers_789defuvw，usd3_67sffedfdsr_789defuvw"
                }
              ],
              "code": {
                "fetch": "// 获取动漫视频 - fetch示例\n        var requestOptions = {\n            method: 'GET',\n            redirect: 'follow'\n        };\n\n        fetch(\"/getwords?page=1&size=10\", requestOptions)\n            .then(response => response.text())\n            .then(result => console.log(result))\n            .catch(error => console.log('error', error));",
                "jquery": "// 获取动漫视频 - jQuery示例\n        var settings = {\n            \"url\": \"/getDongManVideos?grade=grade1&index=1&token=admin_abc123xyz\",\n            \"method\": \"GET\",\n            \"timeout\": 0,\n        };\n\n        $.ajax(settings).done(function (response) {\n            console.log(response);\n        });",
                "axios": "// 获取动漫视频 - axios示例\n        var axios = require('axios');\n\n        var config = {\n            method: 'get',\n            url: '/getDongManVideos?grade=grade1&index=1&token=admin_abc123xyz',\n            headers: {}\n        };\n\n        axios(config)\n            .then(function (response) {\n                console.log(JSON.stringify(response.data));\n            })\n            .catch(function (error) {\n                console.log(error);\n            });",
                "python": "# 获取动漫视频 - Python示例\n        import http.client\n\n        conn = http.client.HTTPSConnection(\"\");\n        payload = '';\n        headers = {}\n        conn.request(\"GET\", \"/getDongManVideos?grade=grade1&index=1&token=admin_abc123xyz\", payload, headers);\n        res = conn.getresponse();\n        data = res.read();\n        print(data.decode(\"utf-8\"));"
              },
              "responseCode": "200 成功",
              "responseType": "application/json",
              "responseJson": "{\n    \"code\": 200,\n    \"message\": \"success\",\n    \"au\": \"公众号【知未AI】\",\n    \"data\": {\n        \"grade\": \"grade1\",\n        \"index\": 1,\n        \"word\": \"b\",\n        \"wordList\": [\n            \"a\",\n            \"b\",\n            \"c\"\n        ],\n        \"pagination\": {\n            \"currentGrade\": \"grade1\",\n            \"currentIndex\": 1,\n            \"totalWords\": 3\n        }\n    }\n}",
